METTLENEST RESOURCE FILES: READ ME FIRST
========================================
...
The three egg folders match the three eggs in the logo:
  1-understand   Understand: the why behind the behaviour
  2-connect      Connect: the shape of an ordinary day
  3-grow         Grow: the next step forward

Inside each egg is a folder for each format, for example:
  research-guides      Research guide
  family-guides        Family guide
  strategy-cards       Strategy card
  tools                Tool
  educator-toolkits    Educator toolkit
  routines             Routine
  sessions             Session
